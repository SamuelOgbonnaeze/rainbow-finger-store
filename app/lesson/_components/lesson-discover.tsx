...
const LessonDiscover = () => {
    return (
        ...
        <>
            <div className="flex items-center justify-between mt-4 md:mt-[60px] ">
                <div className="md:w-[557px] ">
                    <p className="font-nunito font-light text-[64px] leading-[67px] p-3 ">Discover the Joy of  <span className="text-[#DF3B11] font-medium ">Playing Guitar</span></p>
                </div>
                <div className="md:w-[588px] ">
                    <p className="font-hankenGrotesk font-normal text-[24px] leading-[30px] p-3 "> Our courses are designed to fit your schedule and budget, so you can learn at your own pace and on your own terms.</p>
                </div>
            </div>
